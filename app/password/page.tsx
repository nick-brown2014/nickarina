        ...
        <form onSubmit={handleSubmit} className="space-y-2">
          <div className="relative">
            <input
              ...
              autoComplete="off"
              className="w-full bg-black/50 border border-white/30 px-4 py-3 pr-12 text-white text-center placeholder:text-white/50 focus:border-white focus:outline-none transition-colors"
